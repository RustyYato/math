...
protected scoped instance [AddGroupWithOneOps β] : AddGroupWithOneOps (OfEquiv f) := inferInstance

protected scoped instance [Neg β] [NatCast β] [IntCast β] [IsLawfulIntCast β] : IsLawfulIntCast (OfEquiv f) where
